      ...
      <div style={{ maxWidth: 1240, margin: "0 auto", padding: "0 clamp(20px,5vw,72px)" }}>
        <section style={{ padding: "72px 0" }}>
          ...
          <p style={{ fontSize: 16, color: "color-mix(in srgb, var(--color-text) 70%, transparent)", maxWidth: "60ch", marginBottom: 40 }}>
            Ten specific fixes, one goal: numbers the owner can act on. <Link href="/services">See all ten &rarr;</Link>
          </p>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(360px,1fr))", gap: 24 }}>
            <div className="card elev-md" style={{ padding: 28, gap: 16 }}>
              ...
              <p className="card-body" style={{ fontSize: 15, opacity: 1, color: "color-mix(in srgb, var(--color-text) 82%, transparent)" }}>
                A finance operator who already knows Fred, EWC codes and stock sheets &mdash; working alongside your team.
              </p>
              <ul style={{ margin: 0, padding: 0, listStyle: "none", display: "grid", gap: 8, fontSize: 14 }}>
                <li>&mdash; Health Check diagnostic, &pound;2,500 fixed</li>
                <li>&mdash; Fixed-scope improvement projects</li>
                <li>&mdash; Tailored ongoing business partner support</li>
              </ul>
              <Link href="/services" className="btn btn-primary" style={{ alignSelf: "flex-start", marginTop: 8 }}>Explore what you get</Link>
            </div>
            <div className="card elev-md" style={{ padding: 28, gap: 16 }}>
        ...
        <section style={{ paddingBottom: 80, display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(280px,1fr))", gap: 48, alignItems: "center" }}>
          <div>
            ...
            <h2 style={{ fontSize: "clamp(26px,2.8vw,34px)", marginBottom: 16 }}>Built from real yard experience, not theory</h2>
            <p style={{ fontSize: 16, lineHeight: 1.6, color: "color-mix(in srgb, var(--color-text) 80%, transparent)", marginBottom: 20, maxWidth: "52ch" }}>
              25+ years working in finance, including 18 years supporting UK scrap metal and recycling businesses &mdash; building the reports, fixing the stock sheets, sitting in the transport performance meetings.
            </p>
